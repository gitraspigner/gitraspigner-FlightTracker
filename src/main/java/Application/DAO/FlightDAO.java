...
public class FlightDAO {
    ...
    /**
     * DONE: Retrieve all flights from the flight table.
     *
    ...
    /**
     * DONE: Retrieve a specific flight using its flight ID.
     *
     * You only need to change the sql String and set preparedStatement parameters.
     *
    ...
    /**
     * DONE: Add a flight record into the database which matches the values contained in the flight object.
    ...
    public Flight insertFlight(Flight flight){
        ...
        try {
            ...
            //write preparedStatement's setString and setInt methods here.
            //preparedStatement.setInt(0,flight.getFlight_id());
    ...
    /**
     * DONE: Update the flight identified by the flight id to the values contained in the flight object.
     *
     * You only need to change the sql String and set preparedStatement parameters.
     *
    ...
    public void updateFlight(int id, Flight flight){
        ...
        try {
            //Write SQL logic here
            String sql = "update flight set departure_city=?, arrival_city=?, flight_id=? where flight_id=?;";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
    ...
    /**
     * DONE: Retrieve all flights following a particular flight path.
     *
     * you only need to change the sql string and set preparedStatement parameters.
     *
     * Remember that the format of a select where statement written as a Java String looks something like this:
